...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "include directory": r"C:/My Stuff/Coding grounds/Python/Pandas/env/Library/include",
                "lib directory": r"C:/My Stuff/Coding grounds/Python/Pandas/env/Library/lib",
